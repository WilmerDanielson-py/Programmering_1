            ...
            if door == "left" or door == "middle" or door == "right":
                ...
                # Här skapas en strängrepresentation av fienden som valts och vad som händer vid en encounter
                    if Entity_in_room == "Goblin":
                        entity_1.HP_E = entity_1.MaxHP_E
                        print((entity_1))
                        ...
                        if action == "a":
                            ...
                            if chosen_weapon.AtkSpeed_W > entity_1.AtkSpeed_E:
                                print(f"You have chosen to attack with the {chosen_weapon.Name_W}.\n")
                                if chosen_weapon.Hits_W == 0:
                                    print(f"You missed!\n")
                                    Player_1.HP_P = Player_1.HP_P - entity_1.STR_E
                                    print(f"You received {entity_1.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_1.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                                ...
                                entity_1.HP_E = entity_1.HP_E - total_dmg
                                print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {hits_this_turn} hit(s) to the {entity_1.Name_E}!\nIts current {HP} is now {entity_1.HP_E}.\n")
                            elif chosen_weapon.AtkSpeed_W <= entity_1.AtkSpeed_E:
                                print("\nToo slow!\n")
                                print(f"The {entity_1.Name_E} is faster!\n")
                                Player_1.HP_P = Player_1.HP_P - entity_1.STR_E
                                print(f"You received {entity_1.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_1.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                            while entity_1.HP_E > 0 and Player_1.HP_P > 0:
                                hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                                dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                                total_dmg = Player_1.STR_P + dmg_chosen_weapon
                                ...
                                if your_turn == "y":
                                    ...
                                    if Player_1.HP_P <= 0:
                                        alive = False
                                        print(RED("You have been defeated by the " + entity_1.Name_E + ". Game Over!\n"))
                                        break
                                    ...
                                    if escape_ == 1:
                                        ...
                                        print(RED("\nYou failed to escape, but the Goblin got one last hit on you.\n"))
                                        Player_1.HP_P = Player_1.HP_P - 20
                                        print(f"You received 20 {Fore.RED}damage{Style.RESET_ALL} from the {entity_1.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                                    break
                        ...
                        # hittar det valda vapnet med hjälp av namnet och listan över vapen i inventory
                            ...
                            if chosen_weapon.AtkSpeed_W > entity_1.AtkSpeed_E:
                                ...
                                total_dmg = Player_1.STR_P + dmg_chosen_weapon
                                entity_1.HP_E = entity_1.HP_E - total_dmg
                                print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {chosen_weapon.Hits_W} hit(s) to the {entity_1.Name_E}!\nIts current {HP} is now {entity_1.HP_E}.\n")
                            elif chosen_weapon.AtkSpeed_W <= entity_1.AtkSpeed_E:
                                print("\nToo slow!\n")
                                print(f"The {entity_1.Name_E} is faster!\n")
                                Player_1.HP_P = Player_1.HP_P - entity_1.STR_E
                            ...
                            while entity_1.HP_E > 0 and Player_1.HP_P > 0:
                                ...
                                if your_turn == "y":
                                    ...
                                    if escape_ == 1:
                                        ...
                                        print(RED("\nYou escaped, but the " + entity_1.Name_E + " got one last hit on you.\n"))
                                        Player_1.HP_P = Player_1.HP_P - 20
                                        print(f"You received 20 {Fore.RED}damage{Style.RESET_ALL} from the {entity_1.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                                    break
                    ...
                    #     entity_2.HP_E = entity_2.MaxHP_E
                    #     print((entity_2))
                    ...
                    #         if chosen_weapon.AtkSpeed_W > entity_2.AtkSpeed_E:
                    #             print(f"You have chosen to attack with the {chosen_weapon.Name_W}.\n")
                    #             if chosen_weapon.Hits_W == 0:
                    #                 print(f"You missed!\n")
                    #                 Player_1.HP_P = Player_1.HP_P - entity_2.STR_E
                    #                 print(f"You received {entity_2.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_2.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_2.HP_E = entity_2.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {hits_this_turn} hit(s) to the {entity_2.Name_E}!\nIts current {HP} is now {entity_2.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_2.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_2.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_2.STR_E
                    #             print(f"You received {entity_2.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_2.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #         while entity_2.HP_E > 0 and Player_1.HP_P > 0:
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    ...
                    #                 if Player_1.HP_P <= 0:
                    #                     alive = False
                    #                     print(RED("You have been defeated by the " + entity_2.Name_E + ". Game Over!\n"))
                    #                     break
                    #             elif your_turn == "n":
                    #                 escape_ = r.randint(1,2)
                    #                 if escape_ == 1:
                    ...
                    #                     break
                    #                 else:
                    #                     print(RED("\nYou failed to escape! You must now continue the battle!\n"))
                    #                 break
                    #     elif action == "e":
                    #         escape = r.randint(1,3) 
                    #         if escape == 1:
                    ...
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_2.HP_E = entity_2.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {chosen_weapon.Hits_W} hit(s) to the {entity_2.Name_E}!\nIts current {HP} is now {entity_2.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_2.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_2.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_2.STR_E
                    ...
                    #     entity_3.HP_E = entity_3.MaxHP_E
                    #     print((entity_3))
                    ...
                    #         if chosen_weapon.AtkSpeed_W > entity_3.AtkSpeed_E:
                    #             print(f"You have chosen to attack with the {chosen_weapon.Name_W}.\n")
                    #             if chosen_weapon.Hits_W == 0:
                    #                 print(f"You missed!\n")
                    #                 Player_1.HP_P = Player_1.HP_P - entity_3.STR_E
                    #                 print(f"You received {entity_3.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_3.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_3.HP_E = entity_3.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {hits_this_turn} hit(s) to the {entity_3.Name_E}!\nIts current {HP} is now {entity_3.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_3.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_3.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_3.STR_E
                    #             print(f"You received {entity_3.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_3.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #         while entity_3.HP_E > 0 and Player_1.HP_P > 0:
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_3.HP_E = entity_3.HP_E - total_dmg
                    ...
                    #             if Player_1.HP_P <= 0:
                    #                 alive = False
                    #                 print(RED("You have been defeated by the " + entity_3.Name_E + ". Game Over!\n"))
                    #                 break
                    #     elif action == "e":
                    #         escape = r.randint(1,3) 
                    #         if escape == 1:
                    ...
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_3.HP_E = entity_3.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {chosen_weapon.Hits_W} hit(s) to the {entity_3.Name_E}!\nIts current {HP} is now {entity_3.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_3.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_3.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_3.STR_E
                    ...
                    #     entity_4.HP_E = entity_4.MaxHP_E
                    #     print((entity_4))
                    ...
                    #         if chosen_weapon.AtkSpeed_W > entity_4.AtkSpeed_E:
                    #             print(f"You have chosen to attack with the {chosen_weapon.Name_W}.\n")
                    #             if chosen_weapon.Hits_W == 0:
                    #                 print(f"You missed!\n")
                    #                 Player_1.HP_P = Player_1.HP_P - entity_4.STR_E
                    #                 print(f"You received {entity_4.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_4.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_4.HP_E = entity_4.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {hits_this_turn} hit(s) to the {entity_4.Name_E}!\nIts current {HP} is now {entity_4.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_4.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_4.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_4.STR_E
                    #             print(f"You received {entity_4.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_4.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #         while entity_4.HP_E > 0 and Player_1.HP_P > 0:
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_4.HP_E = entity_4.HP_E - total_dmg
                    ...
                    #             if Player_1.HP_P <= 0:
                    #                 alive = False
                    #                 print(RED("You have been defeated by the " + entity_4.Name_E + ". Game Over!\n"))
                    #                 break
                    #     elif action == "e":
                    #         escape = r.randint(1,3) 
                    #         if escape == 1:
                    ...
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_4.HP_E = entity_4.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {chosen_weapon.Hits_W} hit(s) to the {entity_4.Name_E}!\nIts current {HP} is now {entity_4.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_4.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_4.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_4.STR_E
                    ...
                    #     entity_5.HP_E = entity_5.MaxHP_E
                    #     print((entity_5))
                    ...
                    #         if chosen_weapon.AtkSpeed_W > entity_5.AtkSpeed_E:
                    #             print(f"You have chosen to attack with the {chosen_weapon.Name_W}.\n")
                    #             if chosen_weapon.Hits_W == 0:
                    #                 print(f"You missed!\n")
                    #                 Player_1.HP_P = Player_1.HP_P - entity_5.STR_E
                    #                 print(f"You received {entity_5.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_5.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_5.HP_E = entity_5.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {hits_this_turn} hit(s) to the {entity_5.Name_E}!\nIts current {HP} is now {entity_5.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_5.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_5.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_5.STR_E
                    #             print(f"You received {entity_5.STR_E} {Fore.RED}damage{Style.RESET_ALL} from the {entity_5.Name_E}!\nYour current {HP} is now {Player_1.HP_P}/{Player_1.MaxHP_P}.\n")
                    #         while entity_5.HP_E > 0 and Player_1.HP_P > 0:
                    #             hits_this_turn = r.randint(1, chosen_weapon.Hits_W)
                    #             dmg_chosen_weapon = chosen_weapon.Dmg_W * hits_this_turn
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_5.HP_E = entity_5.HP_E - total_dmg
                    ...
                    #             if Player_1.HP_P <= 0:
                    #                 alive = False
                    #                 print(RED("You have been defeated by the " + entity_5.Name_E + ". Game Over!\n"))
                    #                 break
                    #     elif action == "e":
                    #         escape = r.randint(1,3) 
                    #         if escape == 1:
                    ...
                    #             total_dmg = Player_1.STR_P + dmg_chosen_weapon
                    #             entity_5.HP_E = entity_5.HP_E - total_dmg
                    #             print(f"You dealt a total of {total_dmg} {Fore.RED}damage{Style.RESET_ALL} with {chosen_weapon.Hits_W} hit(s) to the {entity_5.Name_E}!\nIts current {HP} is now {entity_5.HP_E}.\n")
                    #         elif chosen_weapon.AtkSpeed_W <= entity_5.AtkSpeed_E:
                    #             print("\nToo slow!\n")
                    #             print(f"The {entity_5.Name_E} is faster!\n")
                    #             Player_1.HP_P = Player_1.HP_P - entity_5.STR_E
