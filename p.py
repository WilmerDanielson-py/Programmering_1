...
item_3 = item(f"{Sheild}", f"Increases max {HP} by 20")
                    ...
                    if Entity_in_room == "Goblin":
                        ...
                        if action == "a":
                            ...
                            if escape == 1:
                                ...
                                print(RED("\nYou failed to escape! You must now prepare for battle!\n"))
                            room_encounter += 1
                            print(f"\nYou have now entered {room_encounter} rooms.\n")
                    ...
                    if loot_room == 1:
                        ...
                        if weapon_chest == 1:
                            ...
                            if len(item_inventory) == 5:
                                full_inv = input("Your item inventory is full! \nYou must use (u) or drop (d) an item before picking up a new one.\n:")
                                if full_inv == "u":
                                ...
                                if new_item.Name_I == (f"{Health} {Elixir}"):
                                    ...
                                    if equip_sheild == "y":
                                        Player_1.MaxHP_P += 20
                                        print(f"\nYou used the {Sheild} and increased your max {HP} by 20! Your current max {HP} is now {Player_1.MaxHP_P}.\n")
                                    elif equip_sheild == "n":
