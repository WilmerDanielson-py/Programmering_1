                    ...
                    if Entity_in_room == "Goblin":
                        ...
                        if action == "a":
                            ...
                            if escape == 1:
                                ...
                                print("You failed to escape! You must now prepare for battle!\n")
                            room_encounter += 1
